...
export const Lab = () => {
  ...
  const execute = async () => {
    setOutput("Ejecutando código en la nube... ⏳");
    ...
    try {
      ...
      if (data.run?.stderr) {
        ...
        setOutput(
          data.run?.output ||
          "Código ejecutado correctamente (Sin salida visible)."
        );
      }
    } catch (error) {
      setOutput("❌ Error al conectar con el servidor de ejecución.");
    }
  };
  ...
  return (
    <div className="fade-in">
      ...
      <p style={{color:'#64748b'}}>
        Escribe y ejecuta código libremente. Un entorno sandbox seguro.
      </p>
